...
%%% Date: 16-Jan-2015::13:23:27
-ifndef('SMM-MIB').
-define('SMM-MIB', true).

%% Notifications
-define(smmGenericTrap, [1,3,6,1,4,1,44890,1,1,2,12]).
-define(smmMuteTrap, [1,3,6,1,4,1,44890,1,1,2,11]).
-define(smmAdiTrap, [1,3,6,1,4,1,44890,1,1,2,10]).
-define(smmBrefTrap, [1,3,6,1,4,1,44890,1,1,2,9]).
...
-define(smmPumpBiasTrap, [1,3,6,1,4,1,44890,1,1,2,4]).
-define(smmPumpTempTrap, [1,3,6,1,4,1,44890,1,1,2,3]).
-define(smmOutputPowerTrap, [1,3,6,1,4,1,44890,1,1,2,2]).
-define(smmInputPowerTrap, [1,3,6,1,4,1,44890,1,1,2,1]).
